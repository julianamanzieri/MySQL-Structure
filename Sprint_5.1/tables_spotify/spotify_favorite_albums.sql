...
CREATE TABLE `favorite_albums` (
  ...
  CONSTRAINT `favorite_albums_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `favorite_albums_ibfk_2` FOREIGN KEY (`album_id`) REFERENCES `album` (`id`)
...
INSERT INTO `favorite_albums` VALUES (1,1,1),(2,1,2),(3,2,1),(4,3,1),(5,3,2),(6,1,3),(7,1,4),(8,2,5),(9,3,7),(10,1,10),(11,2,13),(12,2,14);
